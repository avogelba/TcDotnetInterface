...
namespace OY.TotalCommander.TcPluginInterface.FileSystem {
    ...
    public class FindData {
        ...
        public FindData(string fileName, ulong fileSize, FileAttributes attributes, DateTime? lastWriteTime,
                DateTime? creationTime, DateTime? lastAccessTime)
        ...
        public FindData(string fileName, ulong fileSize, FileAttributes attributes, DateTime? lastWriteTime,
                DateTime? creationTime, DateTime? lastAccessTime, uint reserved0, uint reserved1)
                : this(fileName, fileSize, attributes, lastWriteTime, creationTime, lastAccessTime) {
            Reserved0 = reserved0;
            Reserved1 = reserved1;
        }
