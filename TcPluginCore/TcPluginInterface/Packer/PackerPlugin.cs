...
namespace OY.TotalCommander.TcPluginInterface.Packer {
    public class PackerPlugin: TcPlugin, IPackerPlugin {
        ...
        public virtual object OpenArchive(ref OpenArchiveData archiveData) {
            throw new MethodNotSupportedException("OpenArchive", true);
        }
        ...
        public virtual PackerResult CloseArchive(object arcData) {
            throw new MethodNotSupportedException("CloseArchive", true);
        }
        ...
        public virtual PackerResult PackFiles(string packedFile, string subPath, string srcPath,
        ...
        public virtual PackerResult PackToMem(ref object memData, byte[] bufIn, ref int taken,
        ...
        protected int ProcessDataProc(string fileName, int size) {
            return OnTcPluginEvent(
                new PackerProcessEventArgs(fileName, size));
        }

        protected int ChangeVolProc(string arcName, ChangeValueProcMode mode) {
            return OnTcPluginEvent(
                new PackerChangeVolEventArgs(arcName, (int)mode));
        }
